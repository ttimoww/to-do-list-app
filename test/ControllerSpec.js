...
describe('controller', function () {
	...
	it('should show entries on start-up', function () {
		...
		var todos = [{id: 5, title: 'todo1'}, {id: 5, title: 'todo1'}];
		setUpModel(todos);
		subject.setView('');
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			...
			var todo = {id: 6, title: 'my todo', completed: false};
			setUpModel([todo]);

			subject.setView('');
			view.trigger('toggleAll', { completed: true });

			expect(model.update).toHaveBeenCalledWith(6, { completed: true }, jasmine.any(Function));
			// END MY TEST
		});
		...
		it('should update the view', function () {
			...
			expect(view.render).toHaveBeenCalledWith('elementComplete', {id: 6, completed: true});
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
			...
			var todo = {id: 6, title: 'my todo'};
			setUpModel([todo]);

			subject.setView('');
			subject.removeItem(6);
